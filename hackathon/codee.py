...
while start != "yes" and start != "no":
    ...
    # If yes then pygame, if no then tkinter
    if start == "yes":

        # ---------- Set up pygame ----------
        clock = pygame.time.Clock() # Control running speed
        pygame.init() # Initialize pygame
        font = pygame.font.SysFont(None, 25) # Create font
        ...
        def calculate_mental_state(sleep_hours, stress):
            ...
            # Change parameters into integer
            sleep_hours = int(sleep_hours)
            stress = int(stress)

            # Mental_score calculation
            mental_score = 0 # Set mental_score to 0
            if sleep_hours >= 9:
                mental_score += 10
            elif sleep_hours >= 7:
                mental_score += 7
        ...
        def cal_physical(age_group, sleep_hours, gym_time):
            ...
            # level_score calcultation
            level_score = 5 # Initialize level_score
            if sleep_hours < 6:
                level_score -= 2
            elif sleep_hours > 9:
                level_score -= 1
        ...
        while running:
            ...
            if status == 'game7':
                ...
                if paper_rect.bottom < w+30:
                    ...
                    # main display
                    if part1 == "a":
                        bdialogue("Your likely diagnosis is SANS", l/2, nurse_rect.top-115)
                    elif part1 == "b":
        ...
        # ---------------- Setup ----------------
        root = tk.Tk() # Create main window for Tkinter
        root.title("Space Health Tracker") # Create title
        root.geometry("950x700") # Set screen size
        ...
        def cal_physical(age_group, sleep_hours, gym_time):
            ...
            # Initialize level_score
            level_score = 5

            # level_score calculation
            if sleep_hours < 6:
                level_score -= 2
            elif sleep_hours > 9:
                level_score -= 1
        ...
        def calculate_water(base_water, gym_time, age_group):
            ...
            # Differentiate different age extra water resource receive
            if age_group == "kid":
                extra = gym_time
            elif age_group == "workforce":
                extra = gym_time * 2
            ...
            total = base_water + extra # Total amount of water they obtain
            return extra, total
        ...
        def recommendation(sleep, gym, stress):
            ...
            return "Health balance is overall stable."
        ...
        def start_simulation():
            ...
            next_week_button.config(state="normal") # Turn on the button for user input
